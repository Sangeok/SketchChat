...
export default function ChatInput({socket} : propsType){
    ...
    return (
        <div style={{minHeight:"35px",boxShadow : "rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px"}} className="flex items-center justify-between mb-6 px-3 rounded-md mr-5 ml-5">
